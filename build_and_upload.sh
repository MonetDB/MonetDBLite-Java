...
curl https://search.maven.org/remotecontent?filepath=monetdb/monetdb-jdbc-new/2.36/monetdb-jdbc-new-2.36.jar --output synchronizing/monetdb-jdbc-new-2.36.jar
# Move the monetdb-java-lite jar
mv build/libs/monetdb-java-lite-2.37.jar synchronizing
