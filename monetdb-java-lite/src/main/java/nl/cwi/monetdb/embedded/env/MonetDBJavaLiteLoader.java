...
public final class MonetDBJavaLiteLoader {
	...
	static {
		...
		//2.35 - change the minor version in the next line (The MonetDriver call is need to register the driver in the tests)
		monetDBJDBCDriverString =  MonetDriver.getDriverMajorVersion() + "-35";
	}
